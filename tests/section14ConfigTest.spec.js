 ...
 * Run specific playwright file: npx playwright test tests/section14ConfigTest.spec.js 
 * test.only to run a single test
 * Run specific playwright file in debug mode: npx playwright test tests/section14ConfigTest.spec.js --debug
 * Generate code: npx playwright codegen htps://www.google.com
 * Set workers: npx playwright test tests/section14ConfigTest.spec.js --config playwright.config-other.js --project=chrome
*/
